				...
				<div class="container-wrap">
					<div class="row row-bottom-padded-md">
						<div class="col-md-4">
							<div class="blog-entry-style animate-box">
								<div class="blog-img">
									<a href="blog.html"><img src="{{ ('assets/frontend/images/blog-1.jpg')}}" class="img-responsive" alt="html5 bootstrap template"></a>
								</div>
								<div class="desc">
									<p class="meta">
						...
						<div class="col-md-4">
							<div class="blog-entry-style animate-box">
								<div class="blog-img">
									<a href="blog.html"><img src="{{ ('assets/frontend/images/blog-2.jpg')}}" class="img-responsive" alt="html5 bootstrap template"></a>
								</div>
								<div class="desc">
									<p class="meta">
							...
							<div class="blog-entry-style animate-box">
								<div class="blog-slider">
									<div class="owl-carousel">
										<div class="item">
											<a href="blog.html" class="image-popup-link"><img src="{{ ('assets/frontend/images/blog-3.jpg')}}" class="img-responsive" alt="html5 bootstrap template"></a>
										</div>
										<div class="item">
											<a href="blog.html" class="image-popup-link"><img src="{{ ('assets/frontend/images/blog-4.jpg')}}" class="img-responsive" alt="html5 bootstrap template"></a>
										</div>
									</div>
								</div>
								<div class="desc">
					...
					<div class="row row-bottom-padded-md">
						<div class="col-md-4">
							<div class="blog-entry-style animate-box">
								<div class="blog-img">
									<a href="blog.html"><img src="{{ ('assets/frontend/images/blog-4.jpg')}}" class="img-responsive" alt="html5 bootstrap template"></a>
								</div>
								<div class="desc">
									<p class="meta">
						...
						<div class="col-md-4">
							<div class="blog-entry-style animate-box">
								<div class="blog-img">
									<a href="blog.html"><img src="{{ ('assets/frontend/images/blog-5.jpg')}}" class="img-responsive" alt="html5 bootstrap template"></a>
								</div>
								<div class="desc">
									<p class="meta">
						...
						<div class="col-md-4">
							<div class="blog-entry-style animate-box">
								<div class="blog-img">
									<a href="blog.html"><img src="{{ ('assets/frontend/images/blog-7.jpg')}}" class="img-responsive" alt="html5 bootstrap template"></a>
								</div>
								<div class="desc">
									<p class="meta">
					...
					<div class="row row-bottom-padded-md">
						...
						<div class="col-md-4">
							<div class="blog-entry-style animate-box">
								<div class="blog-img">
									<a href="blog.html"><img src="{{ ('assets/frontend/images/blog-8.jpg')}}" class="img-responsive" alt="html5 bootstrap template"></a>
								</div>
								<div class="desc">
									<p class="meta">
										<span class="cat"><a href="#">Animals</a></span>
					...
					<div class="row row-bottom-padded-md">
						<div class="col-md-4">
							<div class="blog-entry-style animate-box">
								<div class="blog-img">
									<a href="blog.html"><img src="{{ ('assets/frontend/images/blog-9.jpg')}}" class="img-responsive" alt="html5 bootstrap template"></a>
								</div>
								<div class="desc">
									<p class="meta">
						...
						<div class="col-md-4">
							<div class="blog-entry-style animate-box">
								<div class="blog-img">
									<a href="blog.html"><img src="{{ ('assets/frontend/images/blog-10.jpg')}}" class="img-responsive" alt="html5 bootstrap template"></a>
								</div>
								<div class="desc">
									<p class="meta">
										<span class="cat"><a href="#">Auto</a></span>
						...
						<div class="col-md-4">
							<div class="blog-entry-style animate-box">
								<div class="blog-img">
									<a href="blog.html"><img src="{{ ('assets/frontend/images/blog-11.jpg')}}" class="img-responsive" alt="html5 bootstrap template"></a>
								</div>
								<div class="desc">
									<p class="meta">
					...
					<div class="row row-bottom-padded-md">
						<div class="col-md-4">
							<div class="blog-entry-style animate-box">
								<div class="blog-img">
									<a href="blog.html"><img src="{{ ('assets/frontend/images/blog-12.jpg')}}" class="img-responsive" alt="html5 bootstrap template"></a>
								</div>
								<div class="desc">
									<p class="meta">
										<span class="cat"><a href="#">Style</a></span>
						...
						<div class="col-md-8">
							<div class="blog-entry-style animate-box">
								<div class="blog-img">
									<a href="blog.html"><img src="{{ ('assets/frontend/images/blog-13.jpg')}}" class="img-responsive" alt="html5 bootstrap template"></a>
								</div>
								<div class="desc">
									<p class="meta">
										<span class="cat"><a href="#">Style</a></span>
